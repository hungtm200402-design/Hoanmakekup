  ...
  return (
    <>
      ...
      <main className="bg-white">
        <section className="container-beauty overflow-hidden rounded-[10px] bg-brand-pale pb-5">
          <div className="relative overflow-hidden rounded-[10px]">
            <img className="block h-auto w-full select-none object-contain" src="/images/products/hoan_doan_mau_make_san_pham_va_banner/03_banner/banner-trang-chu.png" alt="Tỏa sáng vẻ đẹp tự tin là chính bạn" />
          ...
          <div className="relative z-20 mx-auto -mt-14 grid w-[84%] grid-cols-4 rounded-[18px] bg-white/90 px-5 py-5 shadow-[0_16px_38px_rgba(217,46,85,0.12)] backdrop-blur max-[900px]:mt-0 max-[900px]:w-full max-[900px]:grid-cols-2 max-[520px]:grid-cols-1">
            {stats.map((item) => (
        ...
        <section className="container-beauty grid grid-cols-4 gap-0 py-10 max-[980px]:grid-cols-2 max-[560px]:grid-cols-1">
          {trustItems.map((item) => (
        ...
        <section className="container-beauty pb-10">
        ...
        <section className="container-beauty pb-16">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div className="flex-1 text-center">
