...
export const services = [
  { slug: "makeup-co-dau", title: "MAKEUP CÔ DÂU", price: "3.500.000đ", duration: "2.5 - 3 giờ", desc: "Lớp nền trong trẻo, bền đẹp suốt cả ngày trọng đại.", icon: `${iconBase}/02_icon_dich_vu_uy_tin/05_guong_mat_hoa_sen.png`, image: `${assetBase}/01_mau_make_ban_nu/02_dich_vu_makeup_co_dau.png`, bookingImage: `${assetBase}/01_mau_make_ban_nu/07_dat_lich_thumb_makeup_co_dau.png` },
  { slug: "makeup-du-tiec", title: "MAKEUP DỰ TIỆC", price: "1.800.000đ", duration: "1.5 - 2 giờ", desc: "Makeup sang trọng, cuốn hút cho mọi buổi tiệc.", icon: `${iconBase}/02_icon_dich_vu_uy_tin/11_son_moi.png`, image: `${assetBase}/01_mau_make_ban_nu/03_dich_vu_makeup_du_tiec.png`, bookingImage: `${assetBase}/01_mau_make_ban_nu/08_dat_lich_thumb_makeup_tiec.png` },
  { slug: "makeup-tai-nha", title: "MAKEUP TẠI NHÀ", price: "2.000.000đ", duration: "1.5 - 2 giờ", desc: "Chuyên viên đến tận nơi, tiết kiệm thời gian di chuyển.", icon: `${iconBase}/02_icon_dich_vu_uy_tin/03_chuyen_vien.png`, image: `${assetBase}/01_mau_make_ban_nu/04_dich_vu_makeup_tai_nha.png`, bookingImage: `${assetBase}/01_mau_make_ban_nu/10_dat_lich_thumb_makeup_ca_nhan.png` },
  { slug: "makeup-chup-anh", title: "MAKEUP CHỤP ẢNH", price: "1.500.000đ", duration: "1 - 1.5 giờ", desc: "Tôn lên đường nét, phù hợp với ánh sáng studio và concept.", icon: `${iconBase}/02_icon_dich_vu_uy_tin/07_lap_lanh.png`, image: `${assetBase}/01_mau_make_ban_nu/05_dich_vu_makeup_chup_anh.png`, bookingImage: `${assetBase}/01_mau_make_ban_nu/09_dat_lich_thumb_makeup_di_chup.png` },
  { slug: "makeup-su-kien", title: "MAKEUP SỰ KIỆN", price: "2.500.000đ", duration: "2 - 2.5 giờ", desc: "Phong cách chuyên nghiệp, tự tin trong mọi sự kiện.", icon: `${iconBase}/02_icon_dich_vu_uy_tin/08_trai_tim.png`, image: `${assetBase}/01_mau_make_ban_nu/06_dich_vu_makeup_su_kien.png`, bookingImage: `${assetBase}/01_mau_make_ban_nu/03_dich_vu_makeup_du_tiec.png` }
];
